...
const SettingsPage = () => {
	...
	const { updateOrganization, upgradeOrganization, downgradeOrganization, organizations, currentOrganization } = useOrganizationStore();
		...
		<div className="p-8 max-w-4xl min-w-3/4 mx-auto text-white">
			...
			<div className="pt-4">
				...
				{activeTab === 'Access Management' && (
					<AccessManagement resourceType={itemType} resourceId={id} isAdmin={isAdmin} />
				)}
				...
				{activeTab === 'Integrations' &&
					<div id="integrations-section" className="pt-8">
						<IntegrationManager resourceType={itemType} resourceId={id} />
					</div>
				}
