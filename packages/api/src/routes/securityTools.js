...
/**
 * @route POST /api/v1/security-tools
 * @desc Add a new security tool integration
 * @access Private
 */
...
/**
 * @route GET /api/v1/security-tools
 * @desc Get all security tool integrations for a specific resource
 * @access Private
 */
...
/**
 * @route GET /api/v1/security-tools/:integrationId/snyk/projects
 * @desc Get a list of projects from the Snyk API for a given integration
 * @access Private
 */
...
/**
 * @route POST /api/v1/security-tools/:integrationId/sync
 * @desc Trigger a sync for a specific security tool integration
 * @access Private
 */
...
/**
 * @route GET /api/v1/security-tools/:integrationId/sync-logs
 * @desc Get sync logs for a specific security tool integration
 * @access Private
 */
